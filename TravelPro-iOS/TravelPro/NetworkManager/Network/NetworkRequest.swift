...
public enum HTTPMethod1: String, Equatable {
	/// the GET method
	case get = "GET"
...
open class TravelTaxDayNetworkRequest: NetworkRequestable {
	...
	public var isMultiFormData: Bool?
	...
	public let HTTPMethod: HTTPMethod1
	...
	public init(_ method: HTTPMethod1, authenticatedRequest: Bool = false, shouldExtendBackgroundExecution: Bool = false) {
	...
	public init<T: Encodable>(_ method: HTTPMethod1, authorizationRequirement: AuthorizationRequirement, params: T) {
		HTTPMethod = method
		...
		self.setupHttpBodyData(parameter: params)
		
	}
	
	private func setupHttpBodyData<T: Encodable>(parameter: T) {
		let jsonEncoder = JSONEncoder()
		do {
			parameterData = try jsonEncoder.encode(parameter.self)
		} catch {
			parameterData = nil
		}
	}
	...
	public init(_ method: HTTPMethod1, authorizationRequirement: AuthorizationRequirement) {
		HTTPMethod = method
...
//	func createDataBody(withParameters params: [String: Any]?,
//											media: ImageToData?,
...
//	func multiForm(parameter params: [String: Any]?, image: UIImage, key: String) {
//		
...
//		}
//		
//		let media = ImageToData(withImage: image, forKey: key)
//		
//		if let media = media {
//			body.append("--\(boundary + lineBreak)")
//			body.append("Content-Disposition: form-data; name=\"\(media.key)\"; filename= \"\(media.filename)\"\(lineBreak)")
...
//	}
	...
	open func isEqual(otherRequest: TravelTaxDayNetworkRequest) -> Bool {
	...
	public static func == (lhs: TravelTaxDayNetworkRequest, rhs: TravelTaxDayNetworkRequest) -> Bool {
	...
	internal func updateContentType() {
		...
		contentTypeHeader = TravelTaxDayNetworkRequest.contentType(for: contentType, encoding: encoding)
	}
