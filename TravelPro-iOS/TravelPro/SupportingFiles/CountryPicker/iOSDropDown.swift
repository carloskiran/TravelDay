...
open class DropDown : UITextField{
    ...
    @IBInspectable public var selectedRowColor: UIColor = Constant.sharedInstance.appOrangeColor
        ...
        if isSearchEnable && handleKeyboard{
            NotificationCenter.default.addObserver(forName: UIResponder.keyboardWillShowNotification, object: nil, queue: nil) { (notification) in
                ...
                let userInfo:NSDictionary = notification.userInfo! as NSDictionary
                    if let keyboardFrameData =  userInfo[UIResponder.keyboardFrameEndUserInfoKey] as? NSValue {
                    let keyboardFrame:NSValue = keyboardFrameData
...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.textLabel?.textColor = Constant.sharedInstance.appBlackColor
        return cell!
    }
}
