...
@objc open class PMAlertController: UIViewController {
    ...
    @IBOutlet weak open var xiewX: NSLayoutConstraint!
    
    open var alertStackviewHeight : CGFloat = UIScreen.main.bounds.height < 568.0 ? 40 : 62 //if iphone 4 the stack_view_height is 40, else 62
    ...
    @objc public convenience init(title: String?, description: String?, image: UIImage?, style: PMAlertControllerStyle) {
        ...
        alertViewWidthConstraint.constant = UIScreen.main.bounds.width / 100 * 85  //(style == .alert) ? 270 : UIScreen.main.bounds.width - 60
        ...
        alertActionStackView.layer.cornerRadius = 15
    }
